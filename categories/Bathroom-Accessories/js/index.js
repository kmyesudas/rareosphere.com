...
function shareOnLinkedIn() {
    ...
    window.open('https://www.linkedin.com/sharing/share-offsite/?url=' + url + '&title=' + title + '&summary=' + summary, 'Share on LinkedIn', 'width=600, height=400');
}

// Function to share on WhatsApp
function shareOnWhatsApp() {
    var url = encodeURIComponent(window.location.href);
    window.open('https://api.whatsapp.com/send?text=' + url, 'Share on WhatsApp', 'width=600, height=400');
}

// Function to share on Telegram
function shareOnTelegram() {
    var url = encodeURIComponent(window.location.href);
    window.open('https://t.me/share/url?url=' + url, 'Share on Telegram', 'width=600, height=400');
}
